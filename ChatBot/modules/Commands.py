...
from ChatBot.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@ChatBot.on_message(filters.command(["lang", "language", "setlang"]))
...
@ChatBot.on_message(filters.command("status"))
...
@ChatBot.on_message(filters.command(["resetlang", "nolang"]))
...
@ChatBot.on_message(filters.command("chatbot"))
