...
import random
from ChatBot.database import get_served_chats
...
@ChatBot.on_message(filters.command(SHAYRI_COMMAND))
            ...
            [
                [
                    InlineKeyboardButton(
                        "✿", url=f"https://t.me/ShrutiBots"
                    ),
                    InlineKeyboardButton(
                        "★", url=f"https://t.me/ShrutiBotSupport"
                    ),
                ]
            ]
        ),
